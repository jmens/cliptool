...
public class ParamEditModel extends AbstractModel
{
	...
	public static class Parameter extends AbstractModel implements Comparable<Parameter>
	{
		...
		{
			if ("clipboard".equalsIgnoreCase(getName()))
			{
				return -1;
			}

			if ("clipboard".equalsIgnoreCase(other.getName()))
			{
				return 1;
			}
